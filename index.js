...
let embed = new MessageEmbed().setColor("RANDOM").setAuthor(member.guild.name, member.guild.iconURL({dynamic: true})).setFooter("Âlcadras ❤️ " + member.guild.name).setTimestamp()
if(security === "şüpheli") {
